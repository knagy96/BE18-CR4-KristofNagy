...
<div class="container" >
        ...
        <form method="POST"  class="form-group" enctype="multipart/form-data">
            ...
            <select id="books" name="type" value="<?= $row["type"] ?>" selected>
            ...
            <select id="books" name="type" value="<?= $row["status"] ?>" selected>
    	        <option value="Book">Availalble</option>
                <option value="CD">Reserved</option>
